...
import teamAvatar from '../../assets/image/teamAvatar.png';
import teamAvatar1 from '../../assets/image/teamAvatar1.png';
const people = [
  {
    name: "Ram Hari Bhatta",
    role: "CEO",
    facebookUrl:"",
    desc:"Our organization believes in delivering excellence without any compromise, with the mission of providing eco-friendly cleaning solutions ensuring safety for their fabrics and family. We trust in customer satisfaction as a fuel for our business growth.",
    imageUrl:
      teamAvatar,
  },
  {
    name: "Sushma Pokharel",
    role: "HR Head",
    facebookUrl:"",
    desc:"I feel proud to lead an organization dedicated to creating innovative cleaning solutions that not only effectively remove dust and dirt but also focus on sustainability and customer satisfaction.",
    imageUrl:
    teamAvatar1,
  },
  {
    ...
    facebookUrl:"",
    desc:"Our team has worked tirelessly to ensure that each product meets their quality, efficiency and innovation. From production to packaging we did our best to meet the expectations of each consumer.",
    imageUrl:
    teamAvatar,
  },
  {
    name: "Giri Raj Sharma",
    role: "Counsellor",
    facebookUrl:"",
    desc:"As the counsellor of our detergent company, I am excited to introduce our products that focus on cleanliness, health, and buyer’s expectations. We focus on making your everyday cleaning tasks easier and more effective.",
    imageUrl:
    teamAvatar,
  },
  {
    name: "Pitamber Lamichhane",
    role: "Marketing Manager",
    facebookUrl:"",
    desc:"With deep research into consumer needs and market trends, we came to understand the need and demand of buyers and developed this exciting range of products which offer the best cleaning power and freshness.",
    imageUrl:
    teamAvatar,
  },
  // More people...
    ...
    <section class="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-16">
          ...
          >
            Our teamwork focuses on innovation, dedication, communication and a
            shared commitment to create top-quality, eco-friendly soap and
            detergent solutions through creative effort for company betterment.
          </p>
        </div>
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          {/* <div data-aos="zoom-out-up" data-aos-delay="150" data-aos-duration="600" className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
              ...
              <div data-aos="zoom-out-up" data-aos-delay="200" data-aos-duration="600" className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
              ...
              <div data-aos="zoom-out-up" data-aos-delay="250" data-aos-duration="600" className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                  <a href="#">
